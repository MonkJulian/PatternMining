...
public class Bfs {
	...
	protected SimpleHierarchy taxonomy = SimpleHierarchy.getInstance();
	 ...
	 */
	public Bfs(int sigma, int gamma, int lambda) {
		this.sigma = sigma;
		this.gamma = gamma;
		this.lambda = lambda;
	}
	...
	public void mineAndClear() throws IOException, InterruptedException {
	 ...
	 * @throws IOException
	 */
	private void outputKSequences() throws IOException, InterruptedException {
